...
This repository is being built in milestones. **Milestone 1 (current)** implements core data models and project serialization only. Admin/Client UIs, encryption, and packaging come later.
